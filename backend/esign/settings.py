...
# ALLOWED_HOSTS: mets ici ton host backend Render (ex: esign-5mbk.onrender.com)
ALLOWED_HOSTS = env.list("ALLOWED_HOSTS", default=[
    "localhost", "127.0.0.1",
    # ajoute ton domaine backend render ici si tu veux être strict
...
# Utilise le storage compressé/manifeste (cache-busting)
STORAGES = {
    "staticfiles": {
