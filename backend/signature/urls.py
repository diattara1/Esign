...
urlpatterns = [
    ...
    path('envelopes/<uuid:public_id>/guest/', guest_envelope_view, name='guest-envelope'),
    path('envelopes/<uuid:public_id>/document/', serve_decrypted_pdf, name='signature-serve-decrypted-pdf'),
